#!/usr/bin/env bash
# MolCLR under ChemVL — random_scaffold split batch (4 graph methods).
set -euo pipefail
...
BASE_CONFIGS=(
  configs/external/molclr/molclr_gin_scratch_moleculenet_random_scaffold.external.json
  configs/external/molclr/molclr_gin_molclr_moleculenet_random_scaffold.external.json
  configs/external/molclr/molclr_gcn_scratch_moleculenet_random_scaffold.external.json
  configs/external/molclr/molclr_gcn_molclr_moleculenet_random_scaffold.external.json
)
