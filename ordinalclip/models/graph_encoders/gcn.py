...
class MolCLRGCNConv(MessagePassing):
...
class MolCLRGCN(nn.Module):
    """
    MolCLR GCN encoder copied from https://github.com/yuyangw/MolCLR
    """
    ...
    def __init__(self, num_layer=5, emb_dim=300, feat_dim=256, drop_ratio=0, pool="mean"):
        ...
        for _ in range(num_layer):
            self.gnns.append(MolCLRGCNConv(emb_dim, aggr="add"))
