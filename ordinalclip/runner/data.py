...
class MultiRegressionDataModule(pl.LightningDataModule):
    def __init__(
            self,
            train_images_root,
            val_images_root,
        ...
        self.train_set = MultiRegressionDataset(train_images_root, train_data_file, train_transforms)
        self.val_set = MultiRegressionDataset(val_images_root, val_data_file, eval_transforms)
        self.test_set = MultiRegressionDataset(test_images_root, test_data_file, eval_transforms)
...
class MultiRegressionDataset(Dataset):
    def __init__(self, images_root, data_file, transforms=None):
        self.images_root = images_root
        self.labels = []
        self.images_file = []
